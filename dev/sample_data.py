"""sample_data.py — Realistic sample data for the RFQ schema.

Used by both the test fixtures (conftest.py) and the CLI harness.
"""
...
def get_sample_data() -> dict:
    """Return realistic sample data with all required fields filled."""
    return {
